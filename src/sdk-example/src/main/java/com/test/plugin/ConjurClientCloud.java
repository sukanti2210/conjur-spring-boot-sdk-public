...
public class ConjurClientCloud implements CommandLineRunner{
	private static Logger logger = LoggerFactory.getLogger(ConjurClientCloud.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(ConjurClientCloud.class, args);
    }
